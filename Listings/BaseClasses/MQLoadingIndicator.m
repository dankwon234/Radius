...
@interface MQLoadingIndicator ()
@property (strong, nonatomic) UIView *darkScreen;
@property (strong, nonatomic) UIActivityIndicatorView *spinner;
@end

@implementation MQLoadingIndicator
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.lblMessage.font = [UIFont fontWithName:@"ProximaNova-Regular" size:12.0f];
