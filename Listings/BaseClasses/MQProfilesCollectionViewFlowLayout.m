//
//  MQProfilesCollectionViewFlowLayout.m
//  Listings
//
...
@interface MQProfilesCollectionViewFlowLayout ()
@property (nonatomic, strong) UIDynamicAnimator *dynamicAnimator;
@end


@implementation MQProfilesCollectionViewFlowLayout
...
- (id)init
{
    ...
    if (self){
        ...
        self.itemSize = CGSizeMake(kProfileCellWidth, kListingCellHeight);
        self.sectionInset = UIEdgeInsetsMake(kCellPadding, kCellPadding, 0.0f, kCellPadding);
